                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <span>
                                ...
                                <a href="<?= Url::to(['cart/add', 'id' => $product->id])?>" class="btn btn-default add-to-cart cart" data-id="<?= $product->id?>"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                            </span>
                            <?php if (!empty($product->in_stock)):?>
                                <p><b>Availability:</b> Есть на складе</p>
                            <?else :?>
                                <p><b>Availability:</b> Нет на складе</p>
                            <?php endif;?>

                            <?php if (!empty($product->new)):?>
                                <p><b>Condition:</b> Новинка</p>
                            <?php endif;?>
                            <?php if (!empty($product->sale)):?>
                                <p><b>Condition:</b> Распродажа</p>
                            <?php endif;?>
