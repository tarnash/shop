<div class="table-responsive">
    <table style="width: 100%; border: 1px solid #ddd; border-collapse: collapse;" class="table table-hover table-striped">
        ...
        <tr style="background: #f9f9f9;">
            <th style="padding: 8px; border: 1px solid #ddd;">Фото</th>
        ...
        <?php foreach ($session['cart'] as $id => $item):?>
            <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><?= \yii\helpers\Html::img('@web/images/products/' . $item['img'], ['alt' => $item['name'], 'height' => 50])?></td>
        ...
        <?php endforeach;?>
        <tr>
            <td colspan="4"  style="padding: 8px; border: 1px solid #ddd;">Всего товаров: </td>
